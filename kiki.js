...
case 'sewabot': case 'donasi': case 'sewa': case 'buypremium': case 'donate': {
                kiki.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/302b3781edc343157551c.jpg' }, caption: `*Hai Kak ${m.pushName}*\n\n Bot Rental Prices\n⭔ 13k Per Group via gopay permanen\n⭔ 20k via pulsa  permanen\n\n Premium Price Bot\n⭔ 7k perminggu bulan\n\nPayment can be via Paypal/gopay/pulsa\n\nFor more details, you can chat with the owner\nhttps://wa.me/6285869227650(Owner)\n⭔ GALZ` }, { quoted: m }) 
    }
	break
    case 'grupowner':
m.reply(`https://chat.whatsapp.com/L1QJEg5xdMaKWp3KUKT9vk`)
break
            default:
                if (budy.startsWith('=>')) {
